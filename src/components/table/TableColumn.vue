<template>
  <transition>
    ...
    <el-table-column v-else :prop="col.prop" :sortable="col.sortable" :show-overflow-tooltip="col.tips" :align="col.align || 'center'" :label="col.label"  :width="col.width" :min-width="col.minWidth"  :fixed="col.fixed">
